    ...
    stages {
        ...
        stage("Publish") {
            ...
            steps {
                ...
                ''', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+', remoteDirectory: '/home', remoteDirectorySDF: false, removePrefix: '', sourceFiles: '/home/Github/simple-node-js-react-npm-app/simple-node-js-react-npm-app-master.zip')], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: true)])
            }
        }
    }
}
